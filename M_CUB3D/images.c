...
/*   Updated: 2023/06/19 21:41:10 by okrich           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (nb > 0)
		mlx_destroy_image(mlx, textu.no_text.img);
	nb--;
	if (nb > 0)
		mlx_destroy_image(mlx, textu.so_text.img);
	nb--;
	if (nb > 0)
		mlx_destroy_image(mlx, textu.we_text.img);
	nb--;
	if (nb > 0)
		mlx_destroy_image(mlx, textu.ea_text.img);
