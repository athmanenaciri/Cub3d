...
// 	t_textu	textu;
//
// 	textu.no_text.img = mlx_png_file_to_image(mlx, map.no_text, &textu.no_text.width, &textu.no_text.height);
// 	if (!textu.no_text.img)
// 		return (p_err("convert xpm to img failed\n", 1), textu);
// 	get_data_img(&textu.no_text);
// 	textu.so_text.img = mlx_png_file_to_image(mlx, map.so_text, &textu.so_text.width, &textu.so_text.height);
// 	if (!textu.so_text.img)
// 		return (p_err("convert xpm to img failed\n", 1), textu);
// 	get_data_img(&textu.so_text);
// 	textu.we_text.img = mlx_png_file_to_image(mlx, map.we_text, &textu.we_text.width, &textu.we_text.height);
// 	if (!textu.we_text.img)
// 		return (p_err("convert xpm to img failed\n", 1), textu);
// 	get_data_img(&textu.we_text);
// 	textu.ea_text.img = mlx_png_file_to_image(mlx, map.ea_text, &textu.ea_text.width, &textu.ea_text.height);
// 	if (!textu.ea_text.img)
// 		return (p_err("convert xpm to img failed\n", 1), textu);
// 	get_data_img(&textu.ea_text);
// 	return (free_text(map), textu);
